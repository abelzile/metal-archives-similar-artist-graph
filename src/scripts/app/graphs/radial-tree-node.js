...
export function RadialTreeNode(data) {
  this._data = data;
  this._children = [];
  this._angle = 0;
  this._x = 0;
...
Object.defineProperties(RadialTreeNode.prototype, {
  ...
  rightBisector: {
    get: function() {
      return this._rightBisector;
    },
    set: function(val) {
      this._rightBisector = val;
    },
    enumerable: true
  },
  leftBisector: {
    get: function() {
      return this._leftBisector;
    },
    set: function(val) {
      this._leftBisector = val;
    },
    enumerable: true
  },
  rightTangent: {
    get: function() {
      return this._rightTangent;
    },
    set: function(val) {
      this._rightTangent = val;
    },
    enumerable: true
  },
  leftTangent: {
    get: function() {
      return this._leftTangent;
    },
    set: function(val) {
      this._leftTangent = val;
    },
    enumerable: true
  },
  depth: {
    get: function() {
      ...
      _.forEach(this._children, node => {
        const childDepth = node.depth;
  ...
  leftLimit: {
    get: function() {
      return Math.min(this._leftBisector, this._leftTangent);
    },
    enumerable: true
  },
  rightLimit: {
    get: function() {
      return Math.max(this._rightBisector, this._rightTangent);
    },
    enumerable: true
  },
  level: {
...
_.extend(RadialTreeNode.prototype, {
  ...
  toFlatArray: function() {
    ...
    while (stack.length > 0) {
      ...
      _.forEach(node.children, _.bind(add, this));
    }
  ...
  _toLevelArrayN: function(tree, levels) {
    ...
    levels[treeLevel].push(
      _.map(children, function(node) {
        return node;
      })
    );
